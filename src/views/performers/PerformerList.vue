          ...
          <tbody>
            <vs-tr :data="tr" :key="indextr" v-for="(tr, indextr) in data">
              ...
              <vs-td class="whitespace-no-wrap">
               ...
               <feather-icon icon="EyeIcon" svgClasses="w-5 h-5 hover:text-danger stroke-current" class="ml-2" @click.stop="viewDataModel(tr.id)" />
              </vs-td>
...
import moduleDataList from '@/store/performer-data/PerformerModules.js'
...
export default {
  ...
  methods: {
    ...
    viewDataModel(id){
      console.log(id)
      console.log('enviar a pagina de informacion')
    },
    editData (data) {
