      ...
      jwt.registerUser(displayName, email, password)
        .then(response => {
          ...
          if(response.data.success ){
            ...
            localStorage.setItem('expiresIn', response.data.userData.expiresIn)
            localStorage.setItem('studio_id', response.data.userData.user.studio_id)

            console.log('studio data',response.data.userData.user.studio_id)
